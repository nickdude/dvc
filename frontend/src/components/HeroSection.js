    ...
    return (
        <div className='w-full flex flex-col lg:flex-row items-center justify-center px-4 sm:px-6 lg:px-8 pb-16 lg:pb-28'>
            <div className='flex flex-col max-w-2xl lg:max-w-none text-center lg:text-left'>
                ...
                <div className='flex flex-col sm:flex-row items-center justify-center lg:justify-start mt-8 lg:mt-14 gap-4'>
                    <div className="flex items-center justify-center py-4">
                        <img src={reviewer1} className="h-12 w-12 sm:h-16 sm:w-16 rounded-full object-cover border border-white -ml-3 sm:-ml-5 first:ml-0" />
                        <img src={reviewer2} className="h-12 w-12 sm:h-16 sm:w-16 rounded-full object-cover border border-white -ml-3 sm:-ml-5" />
                        <img src={reviewer3} className="h-12 w-12 sm:h-16 sm:w-16 rounded-full object-cover border border-white -ml-3 sm:-ml-5" />
                        <img src={reviewer4} className="h-12 w-12 sm:h-16 sm:w-16 rounded-full object-cover border border-white -ml-3 sm:-ml-5" />
                        <img src={reviewer5} className="h-12 w-12 sm:h-16 sm:w-16 rounded-full object-cover border border-white -ml-3 sm:-ml-5" />
                    </div>
            ...
            <div className='h-[50vh] sm:h-[60vh] lg:h-[70vh] w-full lg:w-[44vw] mt-8 lg:mt-12 flex items-center justify-center'>
                <img src={heroImage} alt='Hero' className='h-full w-full object-contain lg:object-cover max-w-md lg:max-w-none' />
            </div>
        </div>
    )
}
